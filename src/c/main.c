	  ...
	  // Iterate over all visible columns
	   ...
	   if (y < (colHalf - 28) || y > (colHalf + 26)){
		   ...
		   // Split in left and right halves
		     ...
		     GColor color7 = get_bitmap_pixel_color(fb, fb_format, y+3, xToUse);
		     GColor color8 = get_bitmap_pixel_color(fb, fb_format, y+4, xToUse);	
		     	
		     	  
		     GColor colorToSet = GColorFromRGB(
		     (color1.r + color2.r + color3.r + color4.r + color5.r + color6.r + color7.r + color8.r)*85/8, 
		     (color1.g + color2.g + color3.g + color4.g + color5.g + color6.g + color7.g + color8.g)*85/8,		     
		     (color1.b + color2.b + color3.b + color4.b + color5.b + color6.b + color7.b + color8.b)*85/8);
