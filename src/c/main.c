	   ...
	   if (y < (colHalf - 26) || y > (colHalf + 26)){
	    ...
	    // Iterate over all visible columns
		   for(int x = 0; x < (rowHalf + 40); x++) {
		     ...
		     (color1.r + color2.r + color3.r + color4.r + color5.r + color6.r + color7.r + (settings.BackgroundColor.r * 3))*85/10, 
		     (color1.g + color2.g + color3.g + color4.g + color5.g + color6.g + color7.g + (settings.BackgroundColor.g * 3))*85/10,		     
			    (color1.b + color2.b + color3.b + color4.b + color5.b + color6.b + color7.b + (settings.BackgroundColor.b * 3))*85/10);  
